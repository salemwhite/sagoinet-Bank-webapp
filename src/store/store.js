...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case "setDummyNumber":
      ...
      // return state
      return { ...state, ...dummy };
    // case "setMemberMaster":
    //   const Memdata = { ...state };
    //   Memdata.memberMaster[action.payload.id] = action.payload.value;
    //   return { ...state, ...Memdata };
    // case "resetMemberMaster":
    //   const resetMemdata = { ...state };
    //   resetMemdata.memberMaster = { ...action.payload };
    //   return { ...state, ...resetMemdata };
    default:
      return state;
  }
};
